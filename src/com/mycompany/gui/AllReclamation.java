...
//        tb.addSearchCommand(searchCommand);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        for (Reclamation fi : reclamation) {
            if (fi.getEtat().equals(searchField.getText())){
            Container ct = new Container(BoxLayout.y());
            Label l2 = new Label("Etat de Reclamation: " + fi.getEtat(), "RedLabel");
            ...
            Repondre.getAllStyles().setFgColor(0x0000FF);
            Repondre.getAllStyles().setBgColor(0x0000FF);
            Repondre.getAllStyles().setBorder(Border.createLineBorder(1, 0x0000FF));
            ...
            Repondre.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent evt) {
                    new RepondreReclamation(res, current, fi).show();
                }
            });
            Supprimer.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent evt) {
                    if (Dialog.show("Confirmation", "Voulez vous supprimer cette réclamation ?", "Oui", "Annuler")) {
